...
class APEXStrategy(IStrategy):
    ...
    def protections(self):
        return [
            # Longer cooldown: wait 12 candles (12h) before re-entering same pair
            {"method": "CooldownPeriod", "stop_duration_candles": 12},
            # StoplossGuard: if a pair hits SL 2x in 24h, ban THAT pair for 24h
            {
            ...
            # Global StoplossGuard: if 4 SL hits across all pairs in 12h, pause all 6h
            {
                "method": "StoplossGuard",
